    var BifParser = {
        ...
        getMagicIdentifier: function(b) {
            return this.getHeaderValue(b.slice(0, 9), "magicIdentifier");
        },

        getVersion: function(b) {
            return this.getHeaderValue(b.slice(8, 12), "version");
        },
        ...
        getTimestampMultipler: function(b) {
            return this.getHeaderValue(b.slice(16, 20), "timestampMultipler");
        },
